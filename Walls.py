...
class Wall: #to store coordinates and draw line from the two coordinates to form wall around the track
...
def getWalls():
    #to store objects of Wall for the entrie map
    walls = []

    #creating wall from (12,451) to (15,130)
    ...
    #to append object of Wall to Walls
    walls.append(wall1)
    walls.append(wall2)
    walls.append(wall3)
    walls.append(wall4)
    ...
    #return array containing wall objects (pygame surfaces)
